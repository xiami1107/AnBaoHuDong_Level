...
$(function() {
  ...
  $('.visible-desktop #messages, .visible-desktop #notifications').click(function(e){
    ...
    $('.top-menu #messages').popover({
      ...
      placement: 'bottom',
      title: 'Messages',
      content:'<ul><li><a href="#"><img src="../../../../../../../mstp/assets/js/assets/img/avatars/04.jpg"><span>Today</span><h4>Bill Fernando</h4>Hey John, have you finished the report yet?</a></li><li><a href="#"><img src="../../../../../../../mstp/assets/js/assets/img/avatars/05.jpg"><span>Yesterday</span><h4>Roger White</h4>Did you talk to Andrea? She was looking for you</a></li></ul><div class="popover_footer"><a href="">View all messages</a></div>'
    });
    ...
    $('.top-menu #notifications').popover({
      ...
      placement: 'bottom',
      title: 'Notifications',
      content:'<ul><li><a href="#"><img src="../../../../../../../mstp/assets/js/assets/img/avatars/07.jpg"><span>Today</span><h4>Cody Negley</h4>Requested a vacation for 3 days.</a></li><li><a href="#"><img src="../../../../../../../mstp/assets/js/assets/img/avatars/09.jpg"><span>Yesterday</span><h4>Customer Support</h4>You have 3 new tickets assigned to you.</a></li></ul><div class="popover_footer"><a href="">View all notifications</a></div>'
    });
...
function redraw_dashboard_analytics(){
  ...
  labels: ['Y', 'Z']
   ...
   // init Morris
    ...
    element: 'barchart',
    data: [
      {x: '2019-01-01', y: 102, z:100},
      {x: '2019-01-10', y: 172, z:150},
